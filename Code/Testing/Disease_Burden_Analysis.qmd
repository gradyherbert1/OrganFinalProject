...
## Leading caues of death in the United States, 1997 - 2019

```{r}
#| label: Aggregate disease mortality
#| warning: false
...
saveRDS(Disease_Mortality_Burden_All, here::here("Report", "Figures", "Table_Disease_Mortality_Burden_All.Rds"))

print(Disease_Mortality_Burden_All)
```

```{r}
#| label: Leading cause of death for all
#| warning: false
...
saveRDS(Leading_C_o_D_All, here::here("Report", "Figures", "Table_Leading_C_o_D_All.Rds"))

print(Leading_C_o_D_All)
```

```{r}
#| label: Sex disaggregated disease mortality
...
saveRDS(Disease_Mortality_Burden_Females, here::here("Report", "Figures", "Table_Disease_Mortality_Burden_Females.Rds"))

print(Disease_Mortality_Burden_Females)
```

```{r}
#| label: Leading cause of death for females
#| warning: false
...
# Pivoting longer to determine what years which was higher 
Top_C_o_D_Females_Long <- Top_C_o_D_Females |>
  pivot_longer(
    cols = -Cause_of_Death,
    names_to = "Year",
    values_to = "Mortality"
...
Top_C_o_D_Females_Long <- Top_C_o_D_Females_Long |>
  mutate(Year = as.numeric(Year))

# Getting the top cause of death per year
Top_C_o_D_Females_Long <- Top_C_o_D_Females_Long |>
  group_by(Year) |>
  slice_max(order_by = Mortality, n = 1, with_ties = FALSE) |>
  ungroup()

saveRDS(Top_C_o_D_Females_Long, here::here("Report", "Figures", "Table_Top_C_o_D_Females_Long.Rds"))

print(Top_C_o_D_Females_Long)
```
...
saveRDS(Cardiovascular_Disease_Mortality_Burden_Race, here::here("Report", "Figures", "Table_Cardiovascular_Disease_Mortality_Burden_Race.Rds"))
...
saveRDS(Liver_Disease_Mortality_Burden_Race, here::here("Report", "Figures", "Table_Liver_Disease_Mortality_Burden_Race.Rds"))
...
saveRDS(Kidney_Disease_Mortality_Burden_Race, here::here("Report", "Figures", "Table_Kidney_Disease_Mortality_Burden_Race.Rds"))
...
saveRDS(Donor_Living_Status, here::here("Report", "Figures", "Table_Donor_Living_Status.Rds"))
...
saveRDS(Heart_Recipients, here::here("Report", "Figures", "Table_Heart_Recipients.Rds"))
...
saveRDS(Deceased_v_Living_Organ_Recipients, here::here("Report", "Figures", "Table_Deceased_v_Living_Organ_Recipients.Rds"))
...
saveRDS(Deceased_v_Living_Liver_Recipients, here::here("Report", "Figures", "Table_Deceased_v_Living_Liver_Recipients.Rds"))
...
saveRDS(Deceased_v_Living_Kidney_Recipients, here::here("Report", "Figures", "Table_Deceased_v_Living_Kidney_Recipients.Rds"))
...
print(Plot_Liver_Transplants_Sex)

# It appears that males get deceased donor kidneys more often than females
```
...
saveRDS(ANOVA_Cardiovascular_Disease_Mortality_Burden_Sex, here::here("Report", "Figures", "ANOVA_Cardiovascular_Disease_Mortality_Burden_Sex.rds"))
...
saveRDS(ANOVA_Liver_Disease_Mortality_Burden_Sex, here::here("Report", "Figures", "ANOVA_Liver_Disease_Mortality_Burden_Sex.rds"))
...
saveRDS(ANOVA_Cardiovascular_Disease_Mortality_Burden_Race, here::here("Report", "Figures", "ANOVA_Cardiovascular_Disease_Mortality_Burden_Race.rds"))
